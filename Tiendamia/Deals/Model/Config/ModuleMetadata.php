...
namespace Tiendamia\Deals\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_NAME = 'TiendaMia landing page';

    const PRODUCT_URL = 'https://www.tiendamia.com';

    const MODULE_NAME = 'Tiendamia_Deals';

    const VERSION_CACHE_KEY = 'tiendamia-deals-module-version';
